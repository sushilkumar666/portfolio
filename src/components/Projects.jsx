                        ...
                        <div>
                            ...
                            <div>
                                <div className='project-card' id='pcard1'>
                                    ...
                                    <div className='card-haeding'>World Furniture Expo</div>
                                    <span style={{ fontFamily: "sans-serif" }}>In two days converted the whole website into the new website from WordPress theme to Html, Css, Javascript, Jquery, Boostrap,  with <b>performance, accessibility</b> and <b>SEO</b>, every things in above <b>88%</b>, and load time is just <b>3S</b>. <br /><br />Made 6+ Big Form with API for Buyer & Exhibitor Enquiry</span><br />
                                    <span style={{ fontFamily: "sans-serif" }}> </span>
                                    <span style={{ fontFamily: "sans-serif" }}>Tech :Html, Css, Javascript, Boostrap, Jquery</span>
