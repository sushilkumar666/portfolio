                ...
                <div className='bannerContainer'>
                    <div className='bannerDiv'>
                        ...
                        <div style={{ display: "flex", gap: "20px" }}>
                            <div><a className='button-81' href="https://github.com/ArmanA12">Let's Talk &nbsp;  <i class="fa fa-phone"></i></a></div>
                            <div><a className='button-81' href="https://github.com/ArmanA12">Download CV &nbsp; <i class="fa fa-download"></i></a></div>
                        </div>
                    ...
                    <div style={{ display: "flex", justifyContent: "center" }} className='bannerDiv'>
                        <div className='banner-div-bg'>
                            <img style={{ zIndex: "100" }} src={arman} alt="img" />
